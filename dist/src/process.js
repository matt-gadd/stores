(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@dojo/shim/Promise", "@dojo/shim/Map"], factory);
    }
    ...
    function processExecutor(id, commands, store, callback, transformer) {
        ...
        return function (executorPayload) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var undoOperations, operations, commandsCopy, command, error, payload, results, result, i, e_1;
                ...
                switch (_a.label) {
                    ...
                    case 7:
                        for (i = 0; i < results.length; i++) {
                            ...
                            undoOperations.push.apply(undoOperations, tslib_1.__spread(apply(results[i])));
                        }
                        store.invalidate();
                        command = commandsCopy.shift();
                        return [3 /*break*/, 2];
